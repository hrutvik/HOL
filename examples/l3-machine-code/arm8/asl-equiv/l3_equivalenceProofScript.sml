...
Proof
  ...
  simp[sail2_state_monadTheory.bindS_def, write'X_def] >>
...
Proof
  ...
  qmatch_goalsub_abbrev_tac `X_set _ i v (asl1 : regstate sequential_state)` >>
  `state_rel l3 asl1` by (unabbrev_all_tac >> state_rel_tac[]) >>
  qpat_x_assum `state_rel _ asl` kall_tac >>
  dxrule $ b64 alpha X_set_not_31 >>
  disch_then $ qspecl_then [`64`,`i`,`v`] mp_tac >> simp[Abbr `i`, int_ge] >>
